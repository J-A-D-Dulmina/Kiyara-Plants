...
<head>
    ...
    <link rel="stylesheet" href="contecnt/css/contact.css" />
...
<body>
    ...
    <main class="contact-main">
        ...
        <section class="contact-main-section">
            ...
            <div class="icon-detail-contact">
                <div class="icon-box">

                    <svg class="icon-svg-contact" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="256" height="256" viewBox="0 0 256 256" xml:space="preserve">
                    ...
                    <p><b>Address:&nbsp; </b>62/B, 1st lane, Gothami road, Borella </p>
                </div>
                <div class="icon-box">
                ...
                <div class="icon-box">
                    ...
                    <p><b>Email:&nbsp; </b>info@kiyaraplants.com </p>
                </div>
                <div class="icon-box">
                    ...
                    <p><b>Facbook:&nbsp; </b>Kiyara Plants </p>
                </div>
            </div>
            </div>

            <div class="contact-section-fill-main">
                <div class="contaact-form-main">

                    <h1>Contact US</h1>

                    <form class="contact-from" id="contactForm">

                        <label for="name">Full Name</label>
                        <div class="contaact-form-main-name">
                            <input type="text" id="f-name" name="name" placeholder="First Name" required>
                            <input type="text" id="s-name" name="name" placeholder="Secand Name" required>
                        </div>
                        ...
                        <input type="text" id="subject" name="text" placeholder="Secand Name" placeholder="Subject" required>

                        <label for="message">Message</label>
                        <textarea id="message" name="message" rows="4" placeholder="Message" required></textarea>
                    </form>
                    <button class="form-submit-bt" type="submit" id="submitButton">Submit</button>

                </div>
                <div>
                    <img class="contact-main-image" src="contecnt/img/hero-section/NatureBoyNrth-samsette-01_11zon.jpg" alt="">
                </div>
            </div>
    ...
    <script src="contecnt/js/about.js"></script>
