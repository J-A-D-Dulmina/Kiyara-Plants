...
$settings = array(
    ...
    <p>We collect information such as your name, email address, shipping address, and payment details when you place an order.</p>
    <h2>How We Use Your Information</h2>
    <p>We use your information to process orders, communicate with you about your purchases, and improve our services.</p>
    <h2>Data Security</h2>
...
<div class="container py-5">
    <div class="row">
        <div class="col-12">
            <?php 
            // Display privacy policy content from settings
